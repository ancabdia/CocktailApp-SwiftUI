...
enum CocktailMapper{
    static func mapRemoteOneCocktailToCocktail(remoteCocktail cocktail: RemoteCocktail) -> Cocktail {
        ...
        return Cocktail(id: cocktail.idDrink, name: cocktail.strDrink, category: Category(rawValue: cocktail.strCategory ?? ""), instructions: cocktail.strInstructions, photo: cocktail.strDrinkThumb ?? "none", ingredients: ingredients, measures: measures)
    }
    ...
    static func mapRemoteCocktailsResponseToCocktails(remoteCocktails response: RemoteCocktailsResponse) -> [Cocktail] {
        return response.drinks.map{ remoteCocktail in
            ...
            return Cocktail(
                ...
                category: Category(rawValue: remoteCocktail.strCategory ?? ""),
